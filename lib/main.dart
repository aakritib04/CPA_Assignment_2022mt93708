...
void main() async {
  ...
  final keyApplicationId = 'K3zmUBgzMElBIbV9d20HMQxsW3k6RsTQTcMknTPF';
  final keyClientKey = 'Wu3cVr4OVOntxEDD3E6Gtt14x5NMRd0tKdcSLvKA';
        ...
        child: Column(
          children: [
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Created: ${DateFormat('dd MMMM yyyy').format(task.createdAt)}',
                            style: TextStyle(fontSize: 16),
                          ),
                        ],
                      ),
            ...
            Container(
              ...
              child: Center(
                child: Text(
                  'CPA Assignment by Aakriti Bhardwaj - 2022mt93708@wilp.bits-pilani.ac.in',
                  style: TextStyle(color: Colors.white),
                ),
              ),
            ),
